...
plot FILENAME u 1:2 every ::4 w l linetype 1 lc rgb 'red' notitle, \
     ...
     "" u 1:6:7 every ::4 w yerrorbars linetype 2 lc rgb 'black' title "CA", \
     "" u 1:8:9 every ::4 w yerrorbars linetype 3 lc rgb 'blue' title "EC", \
     "" u 1:10:11 every ::4 w yerrorbars linetype 4 lc rgb 'magenta' title "GC", \
