...
plot FILENAME u 1:2 w l linetype 1 lc rgb 'red' title 'emergenced', \
     FILENAME2 u 1:2 w l linetype 1 lc rgb 'blue' title 'egoWithoutBad', \
     FILENAME3 u 1:2 w l linetype 1 lc rgb 'green' title 'ca', \
